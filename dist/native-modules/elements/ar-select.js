...
var ArSelect = /** @class */ (function () {
    ...
    ArSelect.prototype.addExtraValue = function () {
        var _this = this;
        var vm = arDialog({ type: 'prompt', 'title': this.addExtraValueButtonText });
        vm.whenClosed().then(function (result) {
            if (!result.dismissed && result.value) {
                ...
                var customEvent = DOM.createCustomEvent('change', { bubbles: true, detail: _this.value });
...
export { FilterOptionsValueConverter };
