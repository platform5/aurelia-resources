System.register(["aurelia-templating", "aurelia-pal", "aurelia-binding", "aurelia-dependency-injection", "@aurelia-ux/modal", "../dialogs/prompt-text-dialog"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_templating_1, aurelia_pal_1, aurelia_binding_1, aurelia_dependency_injection_1, modal_1, prompt_text_dialog_1, FilterPromptControl, getVm, defineFilterPromptControlElementApis;
    ...
    return {
        setters: [
            ...
            function (prompt_text_dialog_1_1) {
                prompt_text_dialog_1 = prompt_text_dialog_1_1;
            }
        ],
        execute: function () {
            FilterPromptControl = /** @class */ (function () {
            ...
            exports_1("FilterPromptControl", FilterPromptControl);
            getVm = function (_) { return _.au.controller.viewModel; };
            defineFilterPromptControlElementApis = function (element) {
