System.register(["aurelia-templating", "aurelia-dependency-injection", "@aurelia-ux/core", "aurelia-logging", "aurelia-event-aggregator", "aurelia-framework"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_templating_1, aurelia_dependency_injection_1, core_1, aurelia_logging_1, aurelia_event_aggregator_1, aurelia_framework_1, ArDrawer, ArDrawerToggleAttribute, ArDrawerOpenAttribute, ArDrawerCloseAttribute;
    ...
    exports_1("openDrawer", openDrawer);
    function closeDrawer(id) {
        var vm = getArDrawerFromId(id);
        if (vm)
            vm.close();
    }
    exports_1("closeDrawer", closeDrawer);
    function toggleDrawer(id) {
        var vm = getArDrawerFromId(id);
        if (vm)
            vm.toggle();
    }
    exports_1("toggleDrawer", toggleDrawer);
    ...
    exports_1("onDrawerStatusChanged", onDrawerStatusChanged);
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_1("ArDrawer", ArDrawer);
            ArDrawerToggleAttribute = /** @class */ (function () {
            ...
            exports_1("ArDrawerToggleAttribute", ArDrawerToggleAttribute);
            ArDrawerOpenAttribute = /** @class */ (function () {
            ...
            exports_1("ArDrawerOpenAttribute", ArDrawerOpenAttribute);
            ArDrawerCloseAttribute = /** @class */ (function () {
            ...
            exports_1("ArDrawerCloseAttribute", ArDrawerCloseAttribute);
        }
    };
});
