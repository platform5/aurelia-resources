System.register(["aurelia-templating", "aurelia-dependency-injection", "@aurelia-ux/core"], function (exports_1, context_1) {
    ...
    var aurelia_templating_1, aurelia_dependency_injection_1, core_1, ArList;
        ...
        execute: function () {
            ArList = /** @class */ (function () {
                ...
                ArList = __decorate([
                    ...
                    aurelia_templating_1.customElement('ar-list')
                ], ArList);
                return ArList;
            }());
            exports_1("ArList", ArList);
        }
    };
});
