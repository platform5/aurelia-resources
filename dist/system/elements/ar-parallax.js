System.register(["aurelia-framework", "aurelia-logging"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, aurelia_logging_1, log, ArParallax;
    ...
    return {
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('ar-parallax');
            ArParallax = /** @class */ (function () {
            ...
            exports_1("ArParallax", ArParallax);
        }
    };
});
