System.register(["./../helpers/dom", "aurelia-templating", "aurelia-dependency-injection", "@aurelia-ux/core", "aurelia-logging", "aurelia-event-aggregator", "aurelia-framework", "aurelia-pal", "remove-accents", "./ar-dialog"], function (exports_1, context_1) {
    "use strict";
    ...
    var dom_1, aurelia_templating_1, aurelia_dependency_injection_1, core_1, aurelia_logging_1, aurelia_event_aggregator_1, aurelia_framework_1, aurelia_pal_1, removeAccents, ar_dialog_1, ArSelect, FilterOptionsValueConverter;
    ...
    return {
        setters: [
            ...
            function (ar_dialog_1_1) {
                ar_dialog_1 = ar_dialog_1_1;
            }
        ],
        execute: function () {
            ArSelect = /** @class */ (function () {
            ...
            exports_1("ArSelect", ArSelect);
            FilterOptionsValueConverter = /** @class */ (function () {
            ...
            exports_1("FilterOptionsValueConverter", FilterOptionsValueConverter);
        }
    };
});
