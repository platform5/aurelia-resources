System.register(["aurelia-templating", "aurelia-framework", "aurelia-logging"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_templating_1, aurelia_framework_1, aurelia_logging_1, log, ListingList;
    ...
    return {
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('comp:listing-list');
            ListingList = /** @class */ (function () {
            ...
            exports_1("ListingList", ListingList);
        }
    };
});
