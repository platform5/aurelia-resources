System.register(["aurelia-event-aggregator", "aurelia-framework", "aurelia-logging"], function (exports_1, context_1) {
    "use strict";
    var aurelia_event_aggregator_1, aurelia_framework_1, aurelia_logging_1, eventAggregator, log, PageVisibilityHelpers;
    ...
    return {
        ...
        execute: function () {
            ...
            log = aurelia_logging_1.getLogger('page-visiblity');
            PageVisibilityHelpers = /** @class */ (function () {
            ...
            exports_1("PageVisibilityHelpers", PageVisibilityHelpers);
        }
    };
});
