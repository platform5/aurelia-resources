...
export class ImageUtils {
  ...
  cover(width, height) {
    if (!this.image || !this.image.width || !this.image.height) throw new Error('Image not ready for cover');
    let originalRatio = this.image.width / this.image.height;
